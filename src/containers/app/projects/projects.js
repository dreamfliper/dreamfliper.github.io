	...
	>
		<Wrapper>
			...
			<div className="sr-item-right">
				<b>
					Merge Windows : A <a href="//flashlight.nateparrott.com">Flashlight</a>{' '}
					Plugin
				</b>
				<p>
					Merge macOS application windows into tabs <br />
					example: make many finder windows into single window with tabs <br />
					<a href="https://www.dropbox.com/s/w7ildh25jcfag7x/merge_demo.mov?dl=0">
						demo
					</a>{' '}
					<br />
				...
				<a
					className={`${styles.smSquareBtn} ${styles.githubaltBtn} `}
					href="//github.com/dreamfliper/Flashlight/tree/master/PluginDirectories/1/merge.bundle"
				>
					{' '}
				</a>
				<Link
					className={`${styles.smrSquareBtn} ${styles.textfileBtn} `}
					to={`/note/Flashlight插件開發`}
				/>
			</div>
		...
		<Wrapper>
			...
			<div className="sr-item-left">
				<b>subTrans</b>
				<p>
					A GUI tool swap subtitle between tchinese and schinese,<br /> powered by
					electron-vue and OpenCC
				</p>
